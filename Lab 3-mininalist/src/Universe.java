...
public class Universe {
    public static void main (String []args) {
        ...
        Engineer Klepka = new Engineer("Klepka", PROFESSION.ENGINEER, Moon, 80, ItmoRocket);
        Engineer Zvezdochkin = new Engineer("Zvezdochkin", PROFESSION.ENGINEER, Moon, 60, ItmoRocket);
        Engineer Znayka = new Engineer("Znayka", PROFESSION.ENGINEER, Moon, 120, ItmoRocket);
        ZeroGravityDevice device = new ZeroGravityDevice(STATUS_OF_DEVICE.OFF, "ITMO device");
