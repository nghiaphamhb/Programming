...
+ add_if_max {element} : добавить новый елемент в коллекциюЮ если его зрначение превышает значение наибольшего элемента этой коллекции
+ add_if_max {element} : добавить новый елемент в коллекциюЮ если его зрначение меньше, чем у наименьшего элемента этой коллекции
